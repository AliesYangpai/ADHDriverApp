...
import com.adhdriver.work.ui.iview.driver.IOrderTakeDetailCancelView;
...
public class PresenterDriverOrderTakeDetailCancel extends BasePresenter<IOrderTakeDetailCancelView> {

    private IOrderTakeDetailCancelView iOrderTakeDetailCancelView;
    ...
    public PresenterDriverOrderTakeDetailCancel(IOrderTakeDetailCancelView iOrderTakeDetailCancelView) {
        this.iOrderTakeDetailCancelView = iOrderTakeDetailCancelView;
        ...
        if (vertifyNotNull.isNotNullObj(order)) {
            ...
            if (logicOrderTake.isSameCity(businessType)) {
                ...
                if (vertifyNotNull.isNotNullObj(theOrder)) {
                    ...
                    iOrderTakeDetailCancelView.onDataBackSuccessForSameCityOrderInfo(order);
                    ...
                    if (vertifyNotNull.isNotNullObj(fee)) {
                        ...
                        iOrderTakeDetailCancelView.onDataBackSuccessForSameCityDriveDivide(String.valueOf(driverDivide));
                    }
                    ...
                    iOrderTakeDetailCancelView.doSetPathPointToUi(arry);

                    List<AdditionService> additionServices = theOrder.getAddition_services();
                    if (vertifyNotNull.isNotNullListSize(additionServices)) {
                        iOrderTakeDetailCancelView.onDataBackSuccessForSameCityAdditionService(additionServices);
                        iOrderTakeDetailCancelView.doAdjustViewForAdditionService();
                    } else {
                        iOrderTakeDetailCancelView.doHideViewWithOutAdditionService();
                    }
                }
            }
            ...
            if (logicOrderTake.isFullLoad(businessType)) {
                ...
                if (vertifyNotNull.isNotNullObj(theOrder)) {
                    ...
                    iOrderTakeDetailCancelView.onDataBackSuccessForFullLoadGetOrderInfo(order);

                    Fee fee = theOrder.getFee();

                    float price = functionFee.getFullLoadDriverDivide(fee, order.getDriver_proporition());

                    iOrderTakeDetailCancelView.onDataBackSuccessForFullLoadDriveDivide(String.valueOf(price));
                    ...
                    List<AdditionService> additionServices = theOrder.getAddition_services();
                    if (vertifyNotNull.isNotNullListSize(additionServices)) {
                        iOrderTakeDetailCancelView.onDataBackSuccessForFullLoadAdditionService(additionServices);
                        iOrderTakeDetailCancelView.doAdjustViewForAdditionService();
                    } else {
                        iOrderTakeDetailCancelView.doHideViewWithOutAdditionService();
                    }
            ...
            if (logicOrderTake.isOverOffice(businessType)) {
                ...
                if (vertifyNotNull.isNotNullObj(theOrder)) {
                    ...
                    iOrderTakeDetailCancelView.onDataBackSuccessForOverOfficeGetOrderInfo(order);

                    String divide = functionFee.getOverOfficeDriverDivide(theOrder);

                    iOrderTakeDetailCancelView.onDataBackSuccessForOverOfficeDriveDivide(divide);
                    ...
                    List<AdditionService> additionServices = theOrder.getAddition_services();
                    if (vertifyNotNull.isNotNullListSize(additionServices)) {
                        iOrderTakeDetailCancelView.onDataBackSuccessForOverOfficeAdditionService(additionServices);
                        iOrderTakeDetailCancelView.doAdjustViewForAdditionService();
                    } else {
                        iOrderTakeDetailCancelView.doHideViewWithOutAdditionService();
                    }
