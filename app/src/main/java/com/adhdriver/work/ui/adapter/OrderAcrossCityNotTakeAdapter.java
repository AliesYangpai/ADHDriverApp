...
public class OrderAcrossCityNotTakeAdapter extends BaseQuickAdapter<Order, BaseViewHolder> {


    public OrderAcrossCityNotTakeAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
    }
