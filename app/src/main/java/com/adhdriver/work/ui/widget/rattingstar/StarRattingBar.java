package com.adhdriver.work.ui.widget.rattingstar;
...
/**
 * Created by Alie on 2017/12/31.
 * 类描述
 * 版本
 */

public class StarRattingBar extends View {
    //星星评分
    ...
    public StarRattingBar(Context mContext, AttributeSet attrs) {
        super(mContext, attrs);
        init(mContext, attrs);
    }

    public StarRattingBar(Context mContext, AttributeSet attrs, int defStyleAttr) {
