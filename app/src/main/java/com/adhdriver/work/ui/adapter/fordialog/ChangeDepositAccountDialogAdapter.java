...
public class ChangeDepositAccountDialogAdapter extends BaseAdapter {
    ...
    public ChangeDepositAccountDialogAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      PayChannelInfo payChannelInfo = list.get(position);
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = inflater.inflate(R.layout.item_deposit_change_account_channel, null);
        ...
        vh.tv_center_text.setText(payChannelInfo.getName()+context.getString(R.string.do_change_deposit_account));
