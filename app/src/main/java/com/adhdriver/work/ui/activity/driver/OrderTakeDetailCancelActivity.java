...
import com.adhdriver.work.presenter.driver.PresenterDriverOrderTakeDetailCancel;
...
public class OrderTakeDetailCancelActivity extends BaseActivity<IOrderTakeDetailCancelView, PresenterDriverOrderTakeDetailCancel>
        implements
        View.OnClickListener,
        IOrderTakeDetailCancelView {

    private PresenterDriverOrderTakeDetailCancel presenterDriverOrderTakeDetailCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_take_detail_cancel);


        presenterDriverOrderTakeDetailCancel.doSetDataToUi(currentOrder);
    }

    @Override
    protected PresenterDriverOrderTakeDetailCancel creatPresenter() {
        if (null == presenterDriverOrderTakeDetailCancel) {
            presenterDriverOrderTakeDetailCancel = new PresenterDriverOrderTakeDetailCancel(this);
        }
        return presenterDriverOrderTakeDetailCancel;
    }
