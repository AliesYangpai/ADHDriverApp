...
public class OrderTakeBottomFullLoadPopWindow extends PopupWindow
        implements
    ...
    private OrderFullLoadOperateCallBack orderFullLoadOperateCallBack;


    public void setOrderFullLoadOperateCallBack(OrderFullLoadOperateCallBack orderFullLoadOperateCallBack) {
        this.orderFullLoadOperateCallBack = orderFullLoadOperateCallBack;
    }
...
//or tag.background = this.getResources().getDrawable(R.drawable.custom_bg);
    ...
    public OrderTakeBottomFullLoadPopWindow(Context context, Order order, OrderTagEntity orderTagEntity) {
        super(context);
    ...
    private void doSetBaseData() {
        ...
        tv_price.setText(String.valueOf(functionFee.getFullLoadDriverDivide(fee, order.getDriver_proporition())));
    }
    ...
    private void doSetStartAndEnd() {
       ...
       String departTime =  order.getDeparture_time();
        String arrival_time = order.getArrival_time();
    ...
    private void initViews() {
        ...
        view = this.inflater.inflate(R.layout.popwindow_order_take_full_load_bottom, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_middle_info:
                ToastUtil.showMsg(AiDaiHuoApplication.getInstance(), "跳转到界面详情");
            ...
            case R.id.tv_bottom:
                ...
                ToastUtil.showMsg(AiDaiHuoApplication.getInstance(), "底部滑动出发");
                break;
        }
    }
    ...
    public void onActive() {
        ...
        switch (tag) {
            ...
            case ConstLocalData.ARRIVE_HAD_PAID://到达已付款
                ...
                //滑动发送验证码
                if (null != orderFullLoadOperateCallBack) {
                    orderFullLoadOperateCallBack.onFullLoadGetPhoneCode(order);
                }
                break;
            ...
            case ConstLocalData.DEPART_NOT_ARRIVE://出发未到达
                ...
                if (null != orderFullLoadOperateCallBack) {
                    orderFullLoadOperateCallBack.onFullLoadArrive(order);
                }
                break;
            ...
            case ConstLocalData.DEPART_NOT://未出发
                //滑动到达
                if (null != orderFullLoadOperateCallBack) {
                    orderFullLoadOperateCallBack.onFullLoadDepart(order);
                }
                break;
            ...
            case ConstLocalData.ARRIVE_NOT_PAID://到达未付款
                if (null != orderFullLoadOperateCallBack) {
                    orderFullLoadOperateCallBack.onFullLoadGetPayChannel();
                }
