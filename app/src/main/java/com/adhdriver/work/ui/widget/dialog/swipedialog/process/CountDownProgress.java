package com.adhdriver.work.ui.widget.dialog.swipedialog.process;
...
public class CountDownProgress extends View {
    ...
    private static int defaultCircleStrokeColor = Color.parseColor("#f68623");
    private static int defaultCircleStrokeWidth = 9;
    private static int defaultCircleRadius = 80;
    private static int progressColor = Color.WHITE;
    private static int progressWidth = 10;

    private static int textColor = Color.parseColor("#f68623");
    private static float textSize = 70;
